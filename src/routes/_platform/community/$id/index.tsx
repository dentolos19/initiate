...
import CommentSection from "#/routes/_platform/community/$id/-components/comment-section";
import ProposalSection from "#/routes/_platform/community/$id/-components/proposal-section";
import UserProfile from "#/routes/_platform/community/$id/-components/user-profile";

export const Route = createFileRoute("/_platform/community/$id/")({ component: Page });
...
export default function Page() {
  ...
  return (
    <div className={"flex w-full gap-4 p-4 max-lg:flex-col"}>
      {/* Content */}
