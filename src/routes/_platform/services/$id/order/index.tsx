...
export const Route = createFileRoute("/_platform/services/$id/order/")({ component: Page });
...
export default function Page() {
  ...
  return (
    <Form className={"flex w-full gap-4 p-4 max-lg:flex-col sm:p-6"} form={form} onSubmit={createSubmitHandler()}>
      {/* Left */}
