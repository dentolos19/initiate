...
import NotificationDialog from "#/routes/_platform/manage/(user)/notifications/-components/notification-dialog";

export const Route = createFileRoute("/_platform/manage/(user)/notifications/")({ component: Page });
