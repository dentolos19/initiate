...
import InvoicesTab from "#/routes/_platform/manage/(user)/orders/$id/-components/invoices-tab";
import MilestonesTab from "#/routes/_platform/manage/(user)/orders/$id/-components/milestones-tab";
import OverviewTab from "#/routes/_platform/manage/(user)/orders/$id/-components/overview-tab";

export const Route = createFileRoute("/_platform/manage/(user)/orders/$id/")({ component: Page });
