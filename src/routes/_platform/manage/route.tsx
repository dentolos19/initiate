...
function NestedLayout(props: LayoutProps) {
  ...
  return (
    <>
      <Sidebar className={"mt-16 h-[calc(100dvh-4rem)]"} collapsible={"icon"}>
        <SidebarHeader>
          <SidebarMenu>
            <SidebarMenuItem>
      ...
      <div className={"flex min-w-0 flex-1 flex-col"}>
        <button
          type="button"
          className={"bg-sidebar min-h-11 border-b px-4 text-center text-sm font-medium md:hidden"}
...
export const Route = createFileRoute("/_platform/manage")({
