...
import PlanDeploymentTab from "#/routes/_platform/manage/organization/services/$id/-components/plan-deployment-tab";
import PlanFeaturesTab from "#/routes/_platform/manage/organization/services/$id/-components/plan-features-tab";
import PlanPricingTab from "#/routes/_platform/manage/organization/services/$id/-components/plan-pricing-tab";
