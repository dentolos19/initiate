...
import OverviewTab from "#/routes/_platform/manage/organization/services/$id/-components/overview-tab";
import PlansTab from "#/routes/_platform/manage/organization/services/$id/-components/plans-tab";
import { formSchema, FormValues } from "#/routes/_platform/manage/organization/services/$id/-form";

export const Route = createFileRoute("/_platform/manage/organization/services/$id/")({ component: Page });
