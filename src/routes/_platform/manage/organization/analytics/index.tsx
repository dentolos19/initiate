...
export const Route = createFileRoute("/_platform/manage/organization/analytics/")({
    ...
    <PageShell>
      <PageHeader>
        <PageHeading>
          ...
          <PageDescription>Review your organization’s orders, revenue, and service performance.</PageDescription>
        </PageHeading>
      ...
      <div className="grid border-b sm:grid-cols-2 lg:grid-cols-4">
        <Card className="rounded-none border-0 border-r py-5 shadow-none">
          <CardHeader>
            <CardTitle className="text-sm">Total Revenue</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-semibold tabular-nums">${metrics.totalRevenue}</p>
          </CardContent>
        </Card>
        <Card className="rounded-none border-0 border-r py-5 shadow-none">
          <CardHeader>
          ...
          <CardContent>
            <p className="text-2xl font-semibold tabular-nums">${metrics.mrr}</p>
          </CardContent>
        </Card>
        <Card className="rounded-none border-0 border-r py-5 shadow-none">
          <CardHeader>
          ...
          <CardContent>
            <p className="text-2xl font-semibold tabular-nums">{metrics.totalTransactions}</p>
          </CardContent>
        </Card>
        <Card className="rounded-none border-0 py-5 shadow-none">
          <CardHeader>
            <CardTitle className="text-sm">Avg Order</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-semibold tabular-nums">${metrics.avgOrderValue}</p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card className="rounded-none border-x-0 border-t-0 shadow-none">
          ...
          <CardContent className={"h-72"}>
            {revenueData.length ? (
              ...
              <p className={"text-muted-foreground text-center"}>No revenue data yet.</p>
            )}
          </CardContent>
        </Card>
      </div>
