...
export const Route = createFileRoute("/_platform/manage/platform/resources/documentation/$id/")({
  ...
  return (
    <PageShell>
      <PageHeader className="sm:justify-start">
        ...
        <PageHeading>
          <PageTitle>{isNew ? "Add New Documentation" : "Edit Documentation"}</PageTitle>
          <PageDescription>
            {isNew ? "Create a documentation resource." : "Update this documentation resource."}
          </PageDescription>
        </PageHeading>
      </PageHeader>
