...
export default function ReviewsSection() {
  ...
  function deleteReview(reviewId: string) {
    notifyLoading(
      "Deleting review…",
      backend.organization
        .deleteOrganizationReview(id, reviewId)
        .then(() => {
  ...
  function openEditDialog(review: OrganizationReview) {
    ...
    <Card className={"gap-0 p-6"}>
      ...
      <div className={"grid auto-rows-fr gap-2 sm:grid-cols-2"}>
        ...
        {!loading && reviews.length <= 0 && (
          <div className={"text-muted-foreground my-10 text-center sm:col-span-2"}>
      ...
      {/* Dialog */}
      <ReviewDialog
        data={{ organizationId: id, data: editingReview || undefined }}
        open={dialogOpen}
