...
import DescriptionSection from "#/routes/_platform/organizations/$id/-components/description-section";
import ReviewsSection from "#/routes/_platform/organizations/$id/-components/reviews-section";
import ServicesSection from "#/routes/_platform/organizations/$id/-components/services-section";

export const Route = createFileRoute("/_platform/organizations/$id/")({ component: Page });
  ...
  return (
    <div>
      ...
      <div className={"bg-secondary border-b"}>
        ...
        {/* Info */}
        <div className={"relative flex w-full justify-between gap-4 border-t p-4 pt-12 max-sm:flex-col sm:px-6"}>
          {/* Avatar */}
          <ImageWrapper
