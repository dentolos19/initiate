...
import { CallButtons } from "#/routes/_platform/messages/$id/-components/call-buttons";
import { CallInterface } from "#/routes/_platform/messages/$id/-components/call-interface";
...
export const Route = createFileRoute("/_platform/messages/$id/")({ component: Page });
            ...
            >
              <Popover>
                <PopoverTrigger asChild>
                  <Button aria-label="Add Emoji" type="button" variant="ghost" size="icon">
                    <SmilePlus />
                  </Button>
                </PopoverTrigger>
              ...
              >
                <FileText className={isSummarizing ? "animate-spin motion-reduce:animate-none" : ""} />
              </Button>
              ...
              {isRecording && (
                <div className="flex items-center gap-2 text-red-500">
                  <div className="h-2 w-2 animate-pulse rounded-full bg-red-500 motion-reduce:animate-none" />
              ...
              <Button
                ...
                className={isRecording ? "animate-pulse motion-reduce:animate-none" : ""}
              >
            ...
            {summary && (
              <div className="bg-muted/50 m-2 rounded-lg border p-4">
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <Button aria-label="Close Summary" variant="ghost" size="sm" onClick={() => setSummary(null)}>
                    <X className="h-4 w-4" />
                  </Button>
                </div>
