...
import DescriptionSection from "#/routes/-pages/(platform)/services/[id]/_components/description-section";
import ReviewsSection from "#/routes/-pages/(platform)/services/[id]/_components/reviews-section";
import SimilarSection from "#/routes/-pages/(platform)/services/[id]/_components/similar-section";
  ...
  return (
    <div>
      ...
      <div className={"bg-card border-b"}>
        ...
        <div className={"relative container mx-auto flex justify-between gap-4 p-4 pt-12 max-sm:flex-col"}>
