...
export default function ReviewDialog(props: {
  data: { serviceId: string; data?: ServiceReview };
  open?: boolean;
  ...
  function createSubmitHandler() {
    return form.handleSubmit((values) => {
      ...
      const apiCall = isEditing
        ? backend.service.updateServiceReview(props.data.serviceId, props.data.data!.id, values)
        : backend.service.createServiceReview(props.data.serviceId, values);
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {props.data.data
                ...
                : "Write a review for this service. Your feedback helps others make informed decisions."}
            </DialogDescription>
          </DialogHeader>
