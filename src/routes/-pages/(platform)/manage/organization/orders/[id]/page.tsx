...
import InvoicesTab from "#/routes/-pages/(platform)/manage/organization/orders/[id]/_components/invoices-tab";
import MilestonesTab from "#/routes/-pages/(platform)/manage/organization/orders/[id]/_components/milestones-tab";
import OverviewTab from "#/routes/-pages/(platform)/manage/organization/orders/[id]/_components/overview-tab";
