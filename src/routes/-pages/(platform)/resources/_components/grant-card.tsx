...
export default function GrantCard({ grant, onClick }: { grant: ResourceGrant; onClick?: () => void }) {
  ...
  return (
    <div>
      <Card key={grant.id} className={getCardClassName()} onClick={() => setOpen(true)}>
        {/* Deadline indicator */}
        ...
        <CardContent className={"pt-0"}>
          ...
          {/* AI Analysis Results */}
          {summaryText && (
            <Card className={"from-primary/5 my-6 border bg-gradient-to-br to-transparent shadow-sm"}>
              <CardHeader className={"pb-3"}>
                <div className={"flex items-center justify-between"}>
                  ...
                  {similarityScore > 0 && (
                    <Badge
                      className={`${getSimilarityBadgeColor(similarityScore)} text-xs font-bold text-white shadow-lg`}
                    >
          ...
          <ScrollArea className={"max-h-[85vh] p-6"}>
            ...
            {summaryText && (
              <div className={"mt-6"} id={"ai-analysis"}>
                ...
                <Card className={"from-primary/5 border bg-gradient-to-br to-transparent shadow-sm"}>
                  <CardHeader className={"pb-3"}>
                    <div className={"flex items-center justify-between"}>
                      <CardTitle className={"flex items-center gap-2 text-lg"}>
                        <div className={"bg-primary/10 rounded-full p-1"}>
