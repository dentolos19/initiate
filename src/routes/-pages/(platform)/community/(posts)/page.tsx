...
import ProfileCard from "#/routes/-pages/(platform)/community/(posts)/_components/profile-card";
import TopicsCard from "#/routes/-pages/(platform)/community/(posts)/_components/topics-card";
import PostCard from "#/routes/-pages/(platform)/community/_components/post-card";
...
export default function Page() {
  ...
  return (
    <div className={"container mx-auto flex max-w-5xl gap-4 p-4"}>
