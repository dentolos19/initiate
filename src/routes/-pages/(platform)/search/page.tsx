...
import SearchOrganizations from "#/routes/-pages/(platform)/search/_components/search-organization";
import SearchServices from "#/routes/-pages/(platform)/search/_components/search-services";
import SearchUsers from "#/routes/-pages/(platform)/search/_components/search-users";
